<?php
/*
  About template - Marathon Sci-Fi Design
*/
?>
<?php snippet('header') ?>

<div class="hud-label" style="margin-bottom: 0.75rem;">Profil</div>
<?php snippet('intro') ?>
...
<aside class="contact">
  <div class="hud-label" style="margin-bottom: 1rem;">Kontakt</div>
